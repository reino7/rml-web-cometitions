...
axios({
  method: 'get',
  url: `http://localhost:3001/api/registration/1648376664367-raplamaa-seeriavoistluse-1-etapp-kaiu-auhindadele`,
  responseType: 'json',
        ...
        <tr id="${gamesData[i].matchId}">
          ...
          <td class="text-center">
            <ul class="m-0 p-0">
              ...
              <li class="list-inline-item">
                <button class="btn btn-outline-secondary btn-sm rounded-0" type="button" data-toggle="tooltip"
                  data-placement="top" title="Salvesta"><i class="fas fa-save" onclick="saveGameResults(${gamesData[i].matchId})"></i></button>
              </li>
            </ul>
          </td>
        </tr>
